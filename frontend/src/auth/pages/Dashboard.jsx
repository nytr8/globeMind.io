  ...
  const recentlyAddedItems = [
    {
      badgeType: 'WEBSITE',
      imageUrl: 'https://images.unsplash.com/photo-1614850523459-c2f4c699c52e?q=80&w=800&auto=format&fit=crop',
      title: 'Figma Make: Generate UI with AI',
      sourceText: 'Figma',
    ...
    },
    {
      badgeType: 'ARTICLE',
      imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop',
      title: '10 Principles for Designing Better Dark Modes',
      sourceText: 'UX Collective',
      timeAgoText: '5 hours ago'
    },
    {
      badgeType: 'DOCUMENT',
      imageUrl: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=800&auto=format&fit=crop',
      title: 'Q3 Product Roadmap & Strategy Memo',
      sourceText: 'Internal',
            ...
            <section className="animate-fade-in-up" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-white tracking-wide">Resurfaced for you</h2>
                </div>
            ...
            <section className="animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
              <div className="flex items-center mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-white tracking-wide">Recently added</h2>
                </div>
              </div>
